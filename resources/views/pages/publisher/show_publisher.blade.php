...
<div class="features_items"><!--features_items-->
                        @foreach($publisher_name as $key=>$name)
                         <h2 class="title text-center" style ="padding: 5px; color: #666; text-align: left; border-bottom: 4px solid #00adee;"><i class="fa fa-building-o" aria-hidden="true" style ="color: #00adee;margin-right: 10px;"></i>{{$name->publisher_name}}</h2>
                        @endforeach
