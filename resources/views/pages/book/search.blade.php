...
<div class="features_items"><!--features_items-->
                         ...
                         <h2 class="title text-center" style ="padding: 5px; color: #666; text-align: left; border-bottom: 4px solid #00adee;"><i class="fa fa-search" aria-hidden="true" style ="color: #00adee;margin-right: 10px;"></i>{{'TÌM KIẾM CHO TỪ KHÓA "'.$keyword.'"'}}</h2>
