                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li><a href="{{URL::to('/dieu-khoan-su-dung/')}}"  class="active">Hỗ trợ<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                ...
                <div class="col-sm-3">
                    <div class="left-sidebar" style="">                     
                          ...
                          <div class="panel-group category-products" id="accordian" style="background: #fff; border-radius: 5px;"><!--brands_products-->
                            <h2 style ="margin:0px; text-align: center;">HỖ TRỢ KHÁCH HÀNG</h2>
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    <div class="panel panel-default" style="background: #fff;">
                                        <div class="panel-heading" style="background: #fff;">
                                     
                                            <h4 style="margin-left:0px;" class="panel-title"><a style ="background: none; margin: 0px;" href="{{URL::to('/dieu-khoan-su-dung/')}}">Điều khoản sử dụng</a></h4>
                                        </div>
                                        <div class="panel-heading" style="background: #fff;">

                                            <h4 style="margin-left:0px;" class="panel-title"><a style ="background: none; margin: 0px;" href="{{URL::to('/chinh-sach-doi-tra/')}}">Chính sách đổi - trả - hoàn tiền</a></h4>
                                        </div>
                                        <div class="panel-heading" style="background: #fff;">
                                            <h4 style="margin-left:0px;" class="panel-title"><a style ="background: none; margin: 0px;" href="{{URL::to('/chinh-sach-bao-mat/')}}">Chính sách bảo mật</a></h4>
                                        </div>
                                            <div class="panel-heading" style="background: #fff;">
                                            <h4 style="margin-left:0px;" class="panel-title"><a style ="background: none; margin: 0px;" href="{{URL::to('/qui-dinh-giao-hang/')}}">Qui định giao hàng</a></h4>
                                        </div>
                                            <div class="panel-heading" style="background: #fff;">
                                            <h4 style="margin-left:0px;" class="panel-title"><a style ="background: none; margin: 0px;" href="{{URL::to('/cau-hoi-thuong-gap/')}}">Các câu hỏi thường gặp</a></h4>
                                        </div>
